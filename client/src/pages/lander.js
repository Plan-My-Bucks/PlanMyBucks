        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div className="navbar-buttons mbr-section-btn">
              <a className="btn btn-primary display-4" href="https://mobiri.se">Login</a>
            </div>
          </div>
        </div>
      </nav>
    ...
    <div className="container-fluid">
      <div className="row">
        <div className="content-wrap col-12 col-md-12">
          ...
          <div className="mbr-section-btn"><a className="btn btn-white-outline display-7" href="https://mobiri.se">Get Started</a></div>
        </div>
      </div>
    </div>
  </section>
