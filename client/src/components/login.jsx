                ...
                <div className="login-form">
                    <form onSubmit={handleSubmit} className=" mt-1">
                        ...
                        <div className="flex-row">
                            <span className="span"><a href="/" className="text-blue-400" onClick={handleForgotPassword}>Forgot password?</a></span>
                        </div>
                        <button className="button-submit">Sign In</button>
                        </form>
                        <p className="p">Don't have an account? <a onClick={handleSignupClick} className="span" style={{ cursor: 'pointer' }}>Sign Up</a></p>
